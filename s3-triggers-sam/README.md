...
The application uses several AWS resources, including Lambda functions and two S3 Buckets. These resources are defined in the `template.yaml` file in this project. You can update the template to add AWS resources through the same deployment process that updates your application code.
